    ...
    <div class="auth__overlay">
      <div class="auth__card">
        ...
        <form class="auth__form" @submit.prevent="onSubmit">
          <TextInput v-model="username" placeholder="Имя пользователя" autocomplete="username" />
          <TextInput
            v-model="password"
            type="password"
            class="auth__input"
          ...
          <div class="auth__footer">
            <span class="auth__muted">Нет аккаунта?</span>
            <RouterLink to="/register" class="auth__link">Создать</RouterLink>
          </div>
        </form>
      </div>
    </div>
